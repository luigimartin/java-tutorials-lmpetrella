 ...
 * generated in the it.lmpetrella.tutorial.webservices.wsClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetGreetingResponse_QNAME = new QName("http://wsServer.webservices.tutorial.lmpetrella.it/", "getGreetingResponse");
    private final static QName _GetGreeting_QNAME = new QName("http://wsServer.webservices.tutorial.lmpetrella.it/", "getGreeting");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.lmpetrella.tutorial.webservices.wsClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsServer.webservices.tutorial.lmpetrella.it/", name = "getGreetingResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsServer.webservices.tutorial.lmpetrella.it/", name = "getGreeting")
